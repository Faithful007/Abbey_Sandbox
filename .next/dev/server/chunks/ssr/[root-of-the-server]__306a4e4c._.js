...
function Dashboard() {
    ...
    const exportToExcel = ()=>{
        ...
        try {
            ...
            const infoSheet = __TURBOPACK__imported__module__$5b$externals$5d2f$xlsx__$5b$external$5d$__$28$xlsx$2c$__cjs$29$__["utils"].aoa_to_sheet(infoData);
            __TURBOPACK__imported__module__$5b$externals$5d2f$xlsx__$5b$external$5d$__$28$xlsx$2c$__cjs$29$__["utils"].book_append_sheet(wb, infoSheet, "Info");
            // Data sheet
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$xlsx__$5b$external$5d$__$28$xlsx$2c$__cjs$29$__["utils"].book_append_sheet(wb, dataSheet, "Data");
            // Statistics sheet
            if (statistics?.columnStats) {
                ...
                __TURBOPACK__imported__module__$5b$externals$5d2f$xlsx__$5b$external$5d$__$28$xlsx$2c$__cjs$29$__["utils"].book_append_sheet(wb, statsSheet, "Statistics");
            }
            __TURBOPACK__imported__module__$5b$externals$5d2f$xlsx__$5b$external$5d$__$28$xlsx$2c$__cjs$29$__["writeFile"](wb, `BEC_Analysis_${userName.replace(/\s+/g, "_")}_${Date.now()}.xlsx`);
        } catch (err) {
            alert("Export failed: " + err.message);
        } finally{
            setExporting(false);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__306a4e4c._.js.map